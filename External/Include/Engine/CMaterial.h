...
private:
    ...
    bool m_bMapping;
    tTextureMappingData     m_UVMappingData;
...
public:
    ...
    void SetUVMapping(bool _flag) { m_bMapping = _flag; }
    bool IsUVMapping()const { return m_bMapping; }

    void SetUVMappingData(tTextureMappingData& _data) { m_UVMappingData = _data; }
    tTextureMappingData GetUVMappingData()const { return m_UVMappingData; }
