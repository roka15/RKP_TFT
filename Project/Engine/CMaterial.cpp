...
int CMaterial::Load(const wstring& _strFilePath)
{
	...
	// UV Mapping Setting
	m_UVMappingData.bType = m_Const.mapping.itype;
	m_UVMappingData .vLocation=m_Const.mapping.vMappingLocation;
	m_UVMappingData.vRotation = m_Const.mapping.vMappingRotation;
	m_UVMappingData.vScale = m_Const.mapping.vMappingScale;
